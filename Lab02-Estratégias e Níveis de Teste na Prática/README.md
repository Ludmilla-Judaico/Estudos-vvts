...
### 3.1. [Critérios de Aceitação (User Acceptance Testing)](./diagramas/aceitacao.puml) <br>
### 3.2. [Teste Alfa (Alpha Testing)](./diagramas/alpha.puml) <br>
### 3.3. [Teste Beta (Beta Testing)](./diagramas/beta.puml) <br>
    
## 4. Teste de Sistema (System Testing)
### 4.1. [Teste de Recuperação (Recovery Testing)](./diagramas/recovery.puml) <br>
### 4.2. [Teste de Segurança (Security Testing)](./diagramas/security.puml) <br>
### 4.3. [Teste de Estresse (Stress Testing)](./diagramas/stress.puml) <br>
### 4.4. [Teste de Desempenho (Performance Testing)](./diagramas/performance.puml) <br>
